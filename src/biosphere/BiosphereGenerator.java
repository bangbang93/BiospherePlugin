...
import biosphere.populator.ForestPopulator;
import biosphere.util.NoiseGeneratorOctaves;
import biosphere.populator.DesertPopulator;
import biosphere.populator.TaigaPopulator;
            ...
            for(int x = 0; x < 16; x++)
            {
                ...
                for(int y = 127; y >= 0; y--)
                {
                    ...
                    if(y > midY)
                    {
                        ...
                        {
                            if(y == lakeMidY && biome == Biome.ICE_PLAINS)
                    ...
                    {
                        if(y == lakeMidY && (biome == Biome.ICE_PLAINS || biome == Biome.BEACH))
                            blockID = (byte)Material.ICE.getId();
                        else
                        if(y <= lakeMidY)
                            blockID = (byte)(lavaLake ? Material.LAVA.getId() : Material.WATER.getId());
